      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="w-full">
            ...
            <p className="text-slate-600 leading-7 mb-8 text-sm">
            ...
            <div className="mt-8">
              <p className="font-bold text-sm text-slate-500 mb-2">代表取締役社長</p>
              <div className="font-sans text-xl font-medium text-slate-900">
                成田 タイ
              </div>
            </div>
          </div>
